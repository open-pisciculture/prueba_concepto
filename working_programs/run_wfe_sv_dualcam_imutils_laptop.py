...
def save_video_len(video_len):
    ...
    fps_2 = 70 # Setting FPS for Cam 2
    ...
    out_1 = cv2.VideoWriter(f'cam1_video_date_{date_0}.avi', cv2.VideoWriter_fourcc(*'MJPG'), 70, (640,480) )
    out_2 = cv2.VideoWriter(f'cam2_video_date_{date_0}.avi', cv2.VideoWriter_fourcc(*'MJPG'), 70, (640,480) )
...
if __name__ == "__main__":
    ...
    save_video_len(5)
    print(f"Video saved as cam1_video_date_{date_0}.avi")
